...
export default function SucessMessage({ message}: Props) {
    return (
        <div className="w-1/2 px-4 py-3 text-teal-900 bg-teal-100 border-t-4 border-teal-500 rounded-b shadow-md" role="alert">
            <div className="flex">
